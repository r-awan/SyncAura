...
if(isset($_POST['delete'])){
   ...
   header('location:../../controller/view_posts.php');
...
<section class="read-post">
   ...
   <form method="post">
      ...
      <div class="flex-btn">
         <a href="../../controller/edit_post.php?id=<?= $post_id; ?>" class="inline-option-btn">edit</a>
         <button type="submit" name="delete" class="inline-delete-btn" onclick="return confirm('delete this post?');">delete</button>
         <a href="../../controller/view_posts.php" class="inline-option-btn">go back</a>
      </div>
   </form>
   <?php
         }
